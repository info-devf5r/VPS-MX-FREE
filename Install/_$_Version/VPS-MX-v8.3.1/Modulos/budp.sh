...
if [ "$pid_badvpn" = "" ]; then
    ...
    wget -O /bin/badvpn-udpgw https://raw.githubusercontent.com/info-devf5r/PROYECTOS_DESCONTINUADOS/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX-v8.3.1/Install/ArchivosUtilitarios/badvpn-udpgw &>/dev/null
