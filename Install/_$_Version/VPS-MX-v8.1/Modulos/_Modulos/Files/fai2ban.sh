...
wget -O $HOME/fail2ban https://raw.githubusercontent.com/info-devf5r/PROYECTOS_DESCONTINUADOS/master/NEW-ULTIMATE-VPS-MX-8.0/VPS-MX_Oficial/ArchivosUtilitarios/fail2ban-0.9.4.tar.gz &> /dev/null
